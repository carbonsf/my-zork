...
window.WORLD = {
  ...
  npcs: {
    ...
    smoker: {
      ...
      unknownTopicResponse: "He takes a long drag. Exhales. 'Couldn't say.'",
      showFallback: [
        "He glances at it between drags. Returns his attention to the street.",
        "He takes it in. Keeps smoking. 'Sure,' he says, without elaborating.",
        "He looks at what you're holding. 'Okay.' He pulls on his cigarette."
      ]
    },
    ...
    leo: {
      ...
      unknownTopicResponse: "He looks at you for a moment. 'I don't know anything about that,' he says. He might be lying.",
      showFallback: [
        "He looks at it carefully, then sets it on the table between you. Doesn't say anything.",
        "He examines it without taking it. Nods once, in a way that means he's noted it.",
        "He glances at it. Drinks his beer. His expression doesn't change."
      ],
      ...
      interactions: {
        ...
        "give brass_key": {
          message: "He looks at the brass key. Something crosses his face. 'Marcus makes those.' Very quiet. 'That's his work — you can tell by the hand-finishing.' He gives it back. Doesn't say anything else."
        },
        "give rubber_wristband": {
          message: "He looks at the black wristband without expression. 'Club entry. Someone went to the Powerhouse.' He hands it back and takes a sip of his beer."
        },
        "give wrist_cuff": {
          message: "He looks at the leather cuff for a long moment. 'Someone left that at the Powerhouse. I saw it there last month.' He hands it back. 'Didn't know whose it was.'"
        },
        "give drummer_page": {
          message: "His eyes go to the page. He doesn't reach for it. 'Issue 114.' His voice is quieter. 'Alan had a stack of those at the shop. Marcus used to read them in here.'"
        },
        "give matchbook": {
          message: "He looks at the matchbook. 'Lone Star.' A long pause. 'You talked to them before coming here.' He hands it back. Nods, slightly. You've confirmed something."
        },
        "give uv_flashlight": {
          message: "He looks at the UV flashlight. 'You bought that from Mr. S.' Not a question. 'You're further along than I thought.' He hands it back."
        },
        "kiss": {
    ...
    jude: {
      ...
      unknownTopicResponse: "He shakes his head slowly. 'Can't help you there.' He keeps moving.",
      showFallback: [
        "He sets down whatever he's holding and looks at it. 'Okay.' He's waiting for you to explain.",
        "He glances at it without reaching for it. 'Where'd you get that?'",
        "'Interesting.' He doesn't touch it. Goes back to the bar."
      ],
      shop: {
      ...
      interactions: {
        ...
        "ask about ringold": {
          message: "'Ringold's around the corner. There's a memorial there — standing stones, brass bootprints in the concrete. Marcus was involved in installing some of it, years back.'"
        },
        "ask about eagle": {
          message: "'Eagle's the flagship. Been here forever.' He nods toward the patio. 'If you want to find people from the old community, this is the place to start.'"
        },
        "give brass_key": {
          message: "'Hand-finished.' He turns it over in his hands. 'Someone made this recently. You can tell by the tool marks.' He gives it back. 'Marcus?'"
        },
        "give rubber_wristband": {
          message: "He examines it briefly. 'Club wristband. Powerhouse, probably.' He hands it back. 'Been a while since I went to one of those.'"
        },
        "give wrist_cuff": {
          message: "'Good leather.' He runs his thumb along the edge. 'Workshop quality. That's not off a rack.' He hands it back. 'Where'd you find this?'"
        },
        "give uv_flashlight": {
          message: "'UV light.' He looks from the flashlight to you. 'Someone sent you to read something.' He hands it back without asking what."
        },
        "give matchbook": {
          message: "He sees it and one corner of his mouth lifts. 'You came from the Lone Star.' He hands it back. 'Good. They're good people over there.'"
        }
      }
    },
    ...
    sable: {
      ...
      unknownTopicResponse: "They glance up from the decks. 'No idea. Sorry.' Back to work.",
      showFallback: [
        "They glance at it without taking their hands off the decks. 'Okay.' Back to work.",
        "They look at what you're holding. 'Interesting.' They don't elaborate.",
        "One eyebrow goes up. They look at it for a moment. Then they're back to the music."
      ],
      interactions: {
        "ask about basement": {
    ...
    trick: {
      ...
      unknownTopicResponse: "'Not really my department.' He shrugs one massive shoulder.",
      showFallback: [
        "He takes it in without comment. Hands it back. Doesn't move.",
        "He looks at it once, carefully. 'Nice.' He hands it back. Still blocking the door.",
        "He glances at what you're holding. 'Okay.' He's not moving."
      ],
      interactions: {
        "ask about ringold": {
        ...
        "ask about door": {
          message: "'Private party. Members and guests.' He crosses his arms. 'You can go in through the Eagle if you want a drink.'"
        },
        "ask about eagle": {
          message: "'Eagle's that way.' He nods east. 'Good people in there. Might know who you're looking for.'"
        },
        "kiss": {
          message: "'Not that kind of bar.' He winks."
        },
        "give rubber_wristband": {
          message: "He glances at the black wristband. 'Club night.' He hands it back. 'Wrong wristband for this door, friend.'"
        },
        "give wrist_cuff": {
          message: "He notices the leather cuff. Gives it a slow nod. 'Good work.' He hands it back. Doesn't move."
        },
        "give brass_key": {
          message: "He takes the brass key and turns it over in his big hands. 'That's hand-finished.' He looks at you differently. 'Where'd you get this?' He hands it back, not ready to answer his own question."
        },
        "give drummer_page": {
          message: "He looks at the magazine page. 'Drummer 114.' A quiet pause. 'Old issue. Good one.' He hands it back. Not enough."
        },
        "give key_cuff": {
          message: "He takes in the key clipped to the leather cuff. Something moves behind his eyes. 'That's Marcus's style of work.' He looks at you steadily. 'You know Marcus?' He's asking carefully."
        },
        "give matchbook": {
          message: "'Lone Star.' He glances at it. 'Good bar. Good people.' He hands it back. Still not moving."
        },
        "give uv_flashlight": {
          message: "He raises an eyebrow at the UV flashlight. 'You looking at the walls down there?' He hands it back. 'I've heard about that.'"
        }
      }
    },
    ...
    lone_star_bartender: {
      ...
      unknownTopicResponse: "He shakes his head once, slowly. 'Can't help you with that.'",
      showFallback: [
        "He looks at it without touching it. Sets his cloth down and looks at you. 'Okay.'",
        "'Interesting.' He doesn't reach for it. Resumes wiping the bar.",
        "He glances at it. 'Where'd you pick that up?' He doesn't wait for an answer."
      ],
      shop: {
        "drink": {
          price: 5,
      ...
      interactions: {
        ...
        "ask about ringold": {
          message: "'Ringold Alley's around the corner. There's a standing stone — memorial to some of the old community. Worth seeing, if you haven't.' He goes back to the bar."
        },
        "give brass_key": {
          message: "'Hand-finished.' He turns it over once and sets it on the bar. 'Someone made that recently. That's not a reproduction.' He hands it back."
        },
        "give rubber_wristband": {
          message: "He glances at the black band. 'Powerhouse wristband, looks like.' He goes back to his cloth. 'Long night ahead of you.'"
        },
        "give drummer_page": {
          message: "He reaches for the page and looks at it with care. 'Drummer 114. Marcus donated a whole stack of these to the historical society.' He hands it back. 'He had the original binders.'"
        },
        "give matchbook": {
          message: "He sees it and the corner of his mouth lifts. 'Mine, actually.' He hands it back. 'Well. One of mine. I give those out sometimes.'"
        }
      }
    },
    ...
    clerk: {
      ...
      unknownTopicResponse: "She considers that for a moment. 'I'm not sure I can help with that.'",
      showFallback: [
        "She looks at it with professional interest. 'That's good work.' She doesn't ask where you got it.",
        "She examines it carefully without reaching for it. 'Okay. What would you like to know?'",
        "She gives it a brief, practiced look. 'Interesting. Is there something specific you're trying to do with it?'"
      ],
      shop: {
      ...
      interactions: {
        ...
        "ask about ringold": {
          message: "'Ringold Alley. Marcus spent a lot of time there. The standing stones, the bootprints in the concrete — he helped research the names on those, years ago.'"
        },
        "give brass_key": {
          message: "She takes the key and examines it with a practiced eye. 'Workshop quality. Hand-finished.' She turns it over. 'Marcus Cahill made this.' She hands it back carefully. 'I'd recognize his work anywhere.'"
        },
        "give drummer_page": {
          message: "'Drummer 114.' She handles it gently. 'Marcus donated the original issues to the archive. This one disappeared — he must have taken it for something.' She hands it back. 'It was important to him.'"
        },
        "give wrist_cuff": {
          message: "She examines the leather cuff. 'That was in the workshop. Marcus left it.' She looks up. 'Where did you find this?'"
        },
        "give rubber_wristband": {
          message: "She glances at the rubber wristband. 'Club entry. That's from the Powerhouse, I think.' She hands it back. 'A long night ahead of you.'"
        }
      }
    },
    ...
    marcus: {
      ...
      unknownTopicResponse: "Marcus looks at you. 'I don't know. I've been underground for weeks.' A pause. 'Literally.'",
      showFallback: [
        "Marcus looks at what you're holding. Something in his face — recognition, or memory. 'You've been busy,' he says quietly.",
        "He looks at it with tired eyes. 'You found that up there.' Not a question. 'Good. It matters.'",
        "He examines it without taking it. 'I know what that is.' He doesn't elaborate. Yet."
      ]
    },
    ...
    rubin: {
      ...
      unknownTopicResponse: "She makes a note and looks up. 'I'll look into that.'",
      showFallback: [
        "She looks at it carefully, the way someone looks at evidence. Makes a small note. 'Where did you find that?'",
        "She examines it. 'Okay.' She writes something down. 'This is useful.'",
        "She takes it in with professional attention. 'That's relevant. I'll need to document it.'"
      ]
    }
